...
namespace CosmeticsShop.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddOrder(string payment = "")
        {
            ...
            SentMail("Đặt hàng thành công", user.Email, "hungkhang02@gmail.com", "google..hungkhang02", "<p style=\"font-size:20px\">Cảm ơn bạn đã đặt hàng<br/>Mã đơn hàng của bạn là: " + order.ID);
